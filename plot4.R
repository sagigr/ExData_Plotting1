...
with(subdata, { 
  plot(Global_active_power~HPCdatetime, type="l", ylab="Global Active Power (kilowatts)", xlab="")
  plot(Voltage~HPCdatetime, type="l", ylab="Voltage (volt)", xlab="")
  ...
  plot(Global_reactive_power~HPCdatetime, type="l", ylab="Global Rective Power (kilowatts)",xlab="")
})
